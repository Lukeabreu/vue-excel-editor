			...
			<div class="panel-content">
				<div class="panel-action">
					<button class="panel-button float-left" @click="sort(1)">
						<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sort-alpha-down"
					...
					<button class="panel-button float-right" @click="sort(-1)">
						<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sort-alpha-up-alt"
							 role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
              ...
              <input type="text"
				...
				<div>
					...
					<div v-if="filteredSortedUniqueValueList.length>nFilterCount" class="normal-text"
						 style="float:right">
